<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1393435592,
    'editedby' => 1,
    'editedon' => 1393602281,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1393435620,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
...
<li class="last"><a href="incluir-una-app.html" title="Incluir una app" >Incluir una app</a></li>
                ...
                <div class="col-md-offset-1 col-md-8 col-sm-9">
					...
					<div id="appList">
                        <div class="row">
							[[!getResourcesTag? &tagKey=`tags` &parents=`2` &tpl=`homeAppItem` &sortby=`menuindex` &sortdir=`ASC` &includeTVs=`1` &processTVs=`1` &limit=`0` &resources=`-2`]]
...
<div id="footer">
  ...
  array (
    '[[*pagetitle]]' => 'apps',
    '[[*id]]' => 2,
    '[[~2? &scheme=`full` ]]' => 'http://apps.gob.cl/apps/',
    '[[*content:strip_tags]]' => '',
    '[[*logo]]' => 'http://placehold.it/708x708',
    '[[$openGraph]]' => '<meta property="og:title" content="apps"/>
		<meta property="og:site_name" content="Apps.gob.cl"/>
		<meta property="og:url" content="http://apps.gob.cl/apps/"/>
    ...
    '[[*parent:is=`2`:then=`<meta property="og:title" content="apps"/>
		<meta property="og:site_name" content="Apps.gob.cl"/>
		<meta property="og:url" content="http://apps.gob.cl/apps/"/>
		<meta property="og:description" content=""/>
		<meta property="og:image" content="http://apps.gob.cl/http://placehold.it/708x708"/>
