...
<html lang="en">
    <head>
        ...
        <title>Apps.gob.cl - Inicio</title>
...
<li class="last"><a href="incluir-una-app.html" title="Incluir una app" >Incluir una app</a></li>
                ...
                <div class="col-md-offset-1 col-md-8 col-sm-9">
					[[!getParamFromUrl:notempty=`<h2>[[!getParamFromUrl:striptags? &field=`tag`]]</h2>`? &field=`tag`]]
					<div id="appList">
                        <div class="row">
							[[!getResourcesTag? &tagKey=`tags` &parents=`2` &tpl=`homeAppItem` &sortby=`menuindex` &sortdir=`ASC` &includeTVs=`1` &processTVs=`1` &limit=`0` &resources=`-1`]]
...
<div id="footer">
  ...
  array (
    '[[*pagetitle]]' => 'Inicio',
    '[[*id]]' => 1,
    '[[~1? &scheme=`full` ]]' => 'http://apps.gob.cl/',
    '[[*content:strip_tags]]' => '',
    '[[*logo]]' => 'http://placehold.it/708x708',
    '[[$openGraph]]' => '<meta property="og:title" content="Inicio"/>
		<meta property="og:site_name" content="Apps.gob.cl"/>
		<meta property="og:url" content="http://apps.gob.cl/"/>
    ...
    '[[*parent:is=`2`:then=`<meta property="og:title" content="Inicio"/>
		<meta property="og:site_name" content="Apps.gob.cl"/>
		<meta property="og:url" content="http://apps.gob.cl/"/>
		<meta property="og:description" content=""/>
		<meta property="og:image" content="http://apps.gob.cl/http://placehold.it/708x708"/>
