<?php  return array (
  ...
  array (
    ...
    'isfolder' => 0,
    'introtext' => '',
    'content' => '<p><span style="line-height: 1.5em;">Apps.gob.cl es un repositorio de aplicaciones móviles desarrolladas por la Instituciones Públicas y empresas del Estado de Chile.</span></p>
<p>El sitio apps.gob.cl se enmarca en la iniciativa de utilización y liberación de datos públicos por parte de las instituciones para la creación de aplicaciones de uso ciudadano, este portal impulsado por la Unidad de Modernización y Gobierno Digital de SEGPRES, t<span style="line-height: 1.5em;">iene por objetivo fomentar la transparencia promoviendo el acceso a la información, permitiendo a los ciudadanos encontrarla de manera fácil y en diversos formatos.</span></p>
<p>En este sitio web, podrás encontrar aplicaciones de diferentes temáticas, como por ejemplo: Turismo, transporte, seguridad, salud, entre otras.</p>
<p>Estas herramientas buscan apoyar las actividades que realizas diariamente, proporcionándote acceso a información o servicios de las instituciones del Estado, directamente en tu teléfono móvil.</p>
<p> </p>',
    'richtext' => 1,
    'template' => 3,
    'menuindex' => 2,
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1393602294,
    'editedby' => 1,
    'editedon' => 1394466659,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1393602300,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
    ...
    array (
      0 => 'sideImage',
      1 => 'assets/img/acercade/acerca-de.jpg',
      2 => 'default',
      3 => NULL,
      4 => 'image',
    ),
...
<html lang="en">
    <head>
        ...
        <title>Apps.gob.cl - Acerca de apps.gob.cl</title>
...
<ul class="menu nav nav-pills nav-stacked"><li class="first active"><a href="acerca-de.html" title="Acerca de apps.gob.cl" >Acerca de apps.gob.cl</a></li>
    ...
    <div id="page">
        <div class="row">
            <div class="info col-sm-5 col-sm-offset-2">
                <h3>apps.gob.cl</h3>
                <h2>Acerca de apps.gob.cl</h2>
                <hr />
                <p><span style="line-height: 1.5em;">Apps.gob.cl es un repositorio de aplicaciones móviles desarrolladas por la Instituciones Públicas y empresas del Estado de Chile.</span></p>
<p>El sitio apps.gob.cl se enmarca en la iniciativa de utilización y liberación de datos públicos por parte de las instituciones para la creación de aplicaciones de uso ciudadano, este portal impulsado por la Unidad de Modernización y Gobierno Digital de SEGPRES, t<span style="line-height: 1.5em;">iene por objetivo fomentar la transparencia promoviendo el acceso a la información, permitiendo a los ciudadanos encontrarla de manera fácil y en diversos formatos.</span></p>
<p>En este sitio web, podrás encontrar aplicaciones de diferentes temáticas, como por ejemplo: Turismo, transporte, seguridad, salud, entre otras.</p>
<p>Estas herramientas buscan apoyar las actividades que realizas diariamente, proporcionándote acceso a información o servicios de las instituciones del Estado, directamente en tu teléfono móvil.</p>
<p> </p>
            ...
            <div class="image col-sm-5">
                ...
                <img src="assets/img/acercade/acerca-de.jpg" alt="" />
    ...
    <div>
        ...
        <div id="appList">
                        <div class="row">
							[[!getResourcesTag? &tagKey=`tags` &parents=`2` &tpl=`homeAppItem` &sortby=`menuindex` &sortdir=`ASC` &includeTVs=`1` &processTVs=`1` &limit=`0` &resources=`-11`]]
...
<div id="footer">
  ...
  array (
    '[[*pagetitle]]' => 'Acerca de apps.gob.cl',
    '[[*id]]' => 11,
    '[[~11? &scheme=`full` ]]' => 'http://apps.gob.cl/acerca-de.html',
    '[[*content:strip_tags]]' => 'Apps.gob.cl es un repositorio de aplicaciones móviles desarrolladas por la Instituciones Públicas y empresas del Estado de Chile.
El sitio apps.gob.cl se enmarca en la iniciativa de utilización y liberación de datos públicos por parte de las instituciones para la creación de aplicaciones de uso ciudadano, este portal impulsado por la Unidad de Modernización y Gobierno Digital de SEGPRES, tiene por objetivo fomentar la transparencia promoviendo el acceso a la información, permitiendo a los ciudadanos encontrarla de manera fácil y en diversos formatos.
En este sitio web, podrás encontrar aplicaciones de diferentes temáticas, como por ejemplo: Turismo, transporte, seguridad, salud, entre otras.
Estas herramientas buscan apoyar las actividades que realizas diariamente, proporcionándote acceso a información o servicios de las instituciones del Estado, directamente en tu teléfono móvil.
 ',
    '[[*logo]]' => 'http://placehold.it/708x708',
    '[[$openGraph]]' => '<meta property="og:title" content="Acerca de apps.gob.cl"/>
		<meta property="og:site_name" content="Apps.gob.cl"/>
		<meta property="og:url" content="http://apps.gob.cl/acerca-de.html"/>
		<meta property="og:description" content="Apps.gob.cl es un repositorio de aplicaciones móviles desarrolladas por la Instituciones Públicas y empresas del Estado de Chile.
El sitio apps.gob.cl se enmarca en la iniciativa de utilización y liberación de datos públicos por parte de las instituciones para la creación de aplicaciones de uso ciudadano, este portal impulsado por la Unidad de Modernización y Gobierno Digital de SEGPRES, tiene por objetivo fomentar la transparencia promoviendo el acceso a la información, permitiendo a los ciudadanos encontrarla de manera fácil y en diversos formatos.
En este sitio web, podrás encontrar aplicaciones de diferentes temáticas, como por ejemplo: Turismo, transporte, seguridad, salud, entre otras.
Estas herramientas buscan apoyar las actividades que realizas diariamente, proporcionándote acceso a información o servicios de las instituciones del Estado, directamente en tu teléfono móvil.
 "/>
		<meta property="og:image" content="http://apps.gob.cl/http://placehold.it/708x708"/>
		<meta property="fb:app_id" content="756157744409553"/>',
    '[[*parent:is=`2`:then=`<meta property="og:title" content="Acerca de apps.gob.cl"/>
		<meta property="og:site_name" content="Apps.gob.cl"/>
		<meta property="og:url" content="http://apps.gob.cl/acerca-de.html"/>
		<meta property="og:description" content="Apps.gob.cl es un repositorio de aplicaciones móviles desarrolladas por la Instituciones Públicas y empresas del Estado de Chile.
El sitio apps.gob.cl se enmarca en la iniciativa de utilización y liberación de datos públicos por parte de las instituciones para la creación de aplicaciones de uso ciudadano, este portal impulsado por la Unidad de Modernización y Gobierno Digital de SEGPRES, tiene por objetivo fomentar la transparencia promoviendo el acceso a la información, permitiendo a los ciudadanos encontrarla de manera fácil y en diversos formatos.
...
<a href="?tag=sms">sms (1)</a>
    ...
    '[[Wayfinder? &startId=`0`&level=`1` &outerClass=`menu nav nav-pills nav-stacked` ]]' => '<ul class="menu nav nav-pills nav-stacked"><li class="first active"><a href="acerca-de.html" title="Acerca de apps.gob.cl" >Acerca de apps.gob.cl</a></li>
<li class="last"><a href="incluir-una-app.html" title="Incluir una app" >Incluir una app</a></li>
</ul>',
...
<li class="last"><a href="incluir-una-app.html" title="Incluir una app" >Incluir una app</a></li>
    ...
    '[[*institucion]]' => 'apps.gob.cl',
    '[[*sideImage]]' => 'assets/img/acercade/acerca-de.jpg',
    ...
    array (
      ...
      array (
        ...
        array (
          ...
          'type' => 'image',
          'name' => 'sideImage',
          'caption' => 'Imagen que acompaña al articulo.',
          'description' => '672 px de ancho',
          'editor_type' => 0,
          'category' => 0,
          'locked' => false,
          'elements' => '',
          'rank' => 0,
          'display' => 'default',
          'default_text' => 'http://placehold.it/672x1024',
          'properties' => 
          array (
          ),
          'input_properties' => 
          ...
          'static' => false,
          'static_file' => '',
          'content' => 'http://placehold.it/672x1024',
        ),
        'policies' => 
        array (
          'web' => 
